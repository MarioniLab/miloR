...
# testNhoods(milo.obj, design=~Condition, design.df=milo.design)
# nhoodCounts(milo.obj)
# dge <- DGEList(counts=nhoodCounts(milo.obj), lib.size=colSums(nhoodCounts(milo.obj)))
