...
```{r}
plotDAbeeswarm(groupNhoods(embryo_milo, da_results, max.lfc.delta = 2, overlap=1), group.by = "NhoodGroup") + ggtitle("overlap=1")
plotDAbeeswarm(groupNhoods(embryo_milo, da_results, max.lfc.delta = 2, overlap=5) , group.by = "NhoodGroup") + ggtitle("overlap=5")
plotDAbeeswarm(groupNhoods(embryo_milo, da_results, max.lfc.delta = 2, overlap=10)   , group.by = "NhoodGroup") + ggtitle("overlap=10")
plotDAbeeswarm(groupNhoods(embryo_milo, da_results, max.lfc.delta = 2, overlap=20)   , group.by = "NhoodGroup") + ggtitle("overlap=20")
```

Let's settle for `overlap=5` and `max.lfc.delta=2`

```{r}
set.seed(42)
da_results <- groupNhoods(embryo_milo, da_results, max.lfc.delta = 2, overlap=5)
plotNhoodGroups(embryo_milo, da_results, layout="umap")
