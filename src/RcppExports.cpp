...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(fitGeneticPLGlmm(Z, X, K, muvec, offsets, curr_beta, curr_theta, curr_u, curr_sigma, curr_G, y, u_indices, theta_conv, rlevels, curr_disp, REML, maxit, solver, vardist, disp_as_vc));
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const bool& >::type disp_as_vc(disp_as_vcSEXP);
    Rcpp::traits::input_parameter< std::string >::type solver(solverSEXP);
    rcpp_result_gen = Rcpp::wrap(fitGeneticNullGlmm(Z, X, K, muvec, offsets, curr_beta, curr_u, curr_sigma, y, u_indices, theta_conv, curr_disp, REML, maxit, Kinv_, null_sigma_, null_beta_, null_disp, fix_variance, return_projection, fix_dispersion, max_disp, disp_as_vc, solver));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    {"_miloR_fitGeneticPLGlmm", (DL_FUNC) &_miloR_fitGeneticPLGlmm, 20},
    {"_miloR_fitPLGlmm", (DL_FUNC) &_miloR_fitPLGlmm, 19},
    {"_miloR_fitGeneticNullGlmm", (DL_FUNC) &_miloR_fitGeneticNullGlmm, 24},
